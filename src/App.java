...
public class App {
        public static void main(String[] args) throws Exception {
                ...
                System.out.println("\nArreglo original\n");
                printArray(brands);
                System.out.println("\nArreglo ordenado por años validos (descendente)\n");
                brands = controller.sortSelectionDesc(brands);
                printArray(brands);

        }

        public static void printArray(Brand[] brands){
                for(Brand brand : brands){
                        System.out.println(brand.getBrandName() + " Anios validos " + brand.getTotalValidYears());
                }
        }
